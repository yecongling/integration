 ...
 */
diff_match_patch.prototype.diff_prettyHtml = function(diffs, insModer="", delModer="") {
  var html = [];
  var pattern_amp = /&/g;
  var pattern_lt = /</g;
  var pattern_gt = />/g;
  ...
  for (var x = 0; x < diffs.length; x++) {
    ...
    switch (op) {
      case DIFF_INSERT:
        html[x] = '<ins title="' + insModer + '" style="background:#e6ffe6;">' + text + '</ins>';
        break;
      case DIFF_DELETE:
        html[x] = '<del title="' + delModer + '" style="background:#ffe6e6;">' + text + '</del>';
        break;
      case DIFF_EQUAL:
